...
{
    public class UpdateBuyPortfolioCommand : IRequest<UpdateBuyPortfolioSuccess>
    {
        ...
        private class Mapping : Profile
        {
            public Mapping()
            {
                CreateMap<(PortfolioStock portfolioStock, UpdateBuyPortfolioCommand input), UpdateBuyPortfolioSuccess>()
                .ForMember(view =>
                view.PortfolioId,
